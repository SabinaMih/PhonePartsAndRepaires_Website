"""
Django settings for PhoneRepairShop project.
...
ROOT_URLCONF = 'PhoneRepairShop.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [str(BASE_DIR.joinpath('shop','templates')),
                 str(BASE_DIR.joinpath('booking', 'templates')),
...
WSGI_APPLICATION = 'PhoneRepairShop.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'phonerepairbookings@gmail.com'
EMAIL_HOST_PASSWORD = 'secret'


STRIPE_SECRET_KEY = 'secret:P'
STRIPE_PUBLISHABLE_KEY = 'secret:P'
